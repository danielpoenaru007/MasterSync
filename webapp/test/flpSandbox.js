					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Material Master Request",
									"targetURL": "#zmmatreq-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zmmatreq-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmatreq",
									"url": sap.ui.require.toUrl("zmmatreq")
								}
							}
						}
					}
